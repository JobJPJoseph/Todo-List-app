...
class List {
    ...
    printBoard() {
        ...
        this.items.forEach((item, idx) => {
            console.log([idx.toString().padEnd(5), item.title.padEnd(13), item.deadline, item.mark].join(" | "));
        });
        console.log(str);
        return true;
    }
    ...
    printFullItem(index) {
        const str = '-'.repeat(42);
        console.log(str);
        console.log([this.items[index].title.padEnd(25), this.items[index].deadline.padEnd(14), this.items[index].mark, "\n", this.items[index].description.trimStart()].join(""));
        console.log(str);
        return true;
    }
    ...
    printPriority() {
        ...
        console.log(str);
        console.log([priority.title.padEnd(25), priority.deadline.padEnd(14), priority.mark(), "\n", priority.description.trimStart()].join(""));
        console.log(str);
    }
    ...
    printFullItem(index) {
        ...
        const item = this.items[index];
        console.log(str);
        console.log([item.title.padEnd(25), item.deadline.padEnd(14), item.mark(), "\n", item.description.trimStart()].join(""));
        console.log(str);
    }
